...
const Header: React.FC = () => {
  ...
  const navLinks = [
    ...
    { href: '#quem-somos', labelKey: 'quemSomos' },
      ...
      <div className="container mx-auto px-4 lg:px-5 flex justify-between items-center h-16 lg:h-auto">
        ...
        <div className="flex items-center gap-2 lg:gap-4 overflow-hidden">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="text-[10px] lg:text-xs text-gray tracking-widest whitespace-nowrap hidden sm:block uppercase">CONSULTORIA E INDÚSTRIA</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <div className="relative" ref={langDropdownRef}>
            <button
              ...
              className="bg-light-gray border-none p-2 lg:p-3 rounded-full text-text font-medium cursor-pointer flex items-center justify-center transition-colors hover:bg-accent hover:text-white text-sm lg:text-xl aspect-square"
            >
