        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10 relative z-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {['facebook-f', 'x-twitter', 'linkedin-in', 'instagram'].map(icon => (
          ...
          <div>
            ...
            <ul className="list-none space-y-2">
              ...
              <li><a href="#quem-somos" className="text-accent font-bold hover:text-white transition-colors decoration-0">{t('quemSomos')}</a></li>
